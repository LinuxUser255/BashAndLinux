...
# Print the output of the following commands in bold red
# You can achieve this by combining the printf command with ANSI escape codes and command substitution.
