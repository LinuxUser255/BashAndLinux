...
alias inst='sudo pacman -S' # update && upgrade
alias nn='nvim .zshrc'
alias bb='bat .zshrc'
...
alias opt='cd /opt'
alias med='cd /media'
alias bbb='cd BurpSuitePro;./BurpSuitePro </dev/null &>/dev/null &q; jobs; disown %1'
alias down='cd Downloads'
alias doc='cd Documents'
alias pic='cd Pictures'
alias vid='cd Videos'
alias pw3='passgen'
alias mgo2='cd /opt/Mastering-Go-Second-Edition'
...
alias ii='nvim ~/.i3/config'
alias udemy='cd Downloads/Udemy'
alias brilloup='brillo -q -A 10'
alias brillodown='brillo -q -U 10'
alias labnotes='cd ~/Documents/PortSwiggerLabsNotes/'
alias tutorials='cd ~/Videos/Tutorials/PortSwigger'
alias neo='neofetch'
alias vimvids='cd ~/home/linux/Videos/'
alias vvv='cd ~/Videos/Tutorials/practice'
alias rem='remap'
alias shut='shutdown'
